...
![](figure/estimated_vs_true-1.png)
...
![](figure/posterior_difference-1.png)
...
To help summarize the posterior [Hahn, Murray, and Carvalho (2020)](https://projecteuclid.org/journals/bayesian-analysis/volume-15/issue-3/Bayesian-Regression-Tree-Models-for-Causal-Inference--Regularization-Confounding/10.1214/19-BA1195.full) recommend fitting a CART model where the response variable is the posterior mean unit-specific estimated treatment effect from BCF ($\hat\tau(x_i)$)
...
![](figure/subgroup_posterior-1.png)
...
![](figure/subgroup_posterior-2.png)
...
![](figure/subgroup_posterior-3.png)
...
![](figure/subgroup_posterior-4.png)
