...
plot(density(bcf_out$tau[,ix[1]] - bcf_out$tau[,ix[2]]), main="Posterior for difference in CATEs")
...
qplot(whiTaus - wloTaus, geom="density", main="Posterior disribution of difference\n between subgroup ATEs", 
...
# Node that the node indices here are different than in the code block above
...
plot(density(post_largest), xlim=c(0,1.2), ylim=c(0,9), main = "Largest CATE subgp \n vs others")
