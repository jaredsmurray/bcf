...
Since our "$\hat{R}$" (Gelman and Rubin's convergence factor) are between 0.9 and 1.1, we are fairly confident that our run successfully achieved convergence. 
The multivariate PSRF of 1.7 reinforces our conclusion. [TODO: LVF: Is 1.7 actually acceptable for a multivariate PSRF?  And should we spell out PSRF, since readers might not know what it stands for?] 
